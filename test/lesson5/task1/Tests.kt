...
class Tests {
    ...
    fun containsIn() {
        ...
        assertTrue(
            containsIn(
                mapOf("a" to "z", "b" to "sweet", "zorro" to "strike"),
                mapOf("a" to "z", "b" to "sweet", "xc" to "ccc", "zorro" to "strike")
            )
        )
    ...
    fun propagateHandshakes() {
        ...
        assertEquals(
            mapOf(
                "Marat" to setOf("Mikhail", "Sveta", "John", "Ignat", "Vasiliy"),
                "Sveta" to setOf("Mikhail", "John", "Ignat", "Vasiliy"),
                "Mikhail" to setOf(),
                "John" to setOf(),
                "Ignat" to setOf(),
                "Vasiliy" to setOf()
    ...
    fun findSumOfTwo() {
        ...
        assertEquals(
            Pair(3, 4),
            findSumOfTwo(listOf(255, 622, 357, 0, 3, 3, 7), 3)
        )
        assertEquals(
            Pair(0, 1),
    ...
    fun bagPacking() {
        ...
        assertEquals(
            setOf("hh"),
            bagPacking(mapOf("Kotel" to (1 to 2500), "Kot;" to (2 to 2000), "hh" to (3 to 10000)), 3)
        )
        assertEquals(
            setOf("0", "1"),
            bagPacking(
